...
class CropBandView @JvmOverloads constructor(
    ...
    /**
     * Axis-aligned crop rectangle in source bitmap pixel coordinates
     * (same math as [exportCropped]'s sx,sy,ex,ey). Null if no source.
     */
    fun sourceCropRect(): RectF? {
