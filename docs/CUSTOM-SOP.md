...
| 项目 | 说明 |
|------|------|
| 渠道 | 微信 `anpple` / 抖音 `anpplex`（非应用内支付） |
| 参考价 | ¥39 / ¥99（以实际报价为准） |
| 交付规格 | 推荐 **2990×284** JPEG；或 4032×284 全条由应用裁取右侧壁纸区 |

相关：[THEME-PACK.md](./THEME-PACK.md) · [SECURITY-REDEEM-CODES.md](./SECURITY-REDEEM-CODES.md)
...
```text
星澜壁纸定制：阿维塔星环空闲条（2990×284）
· 报价：单图 ¥__ / 精修 ¥__
· 交付：兑换码 1 个（一码一设备）或直发 jpg
· 修改：初稿含 1 次微调；大幅改版另议
· 请提供：参考图、色调、是否需要深色/浅色两版
```

不承接：侵权素材、暴力内容、无法适配条带构图、音视频需求。
