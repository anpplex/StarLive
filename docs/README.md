...
| 文档 | 说明 | 状态 |
|------|------|------|
| [FEATURE-ALIGNMENT-1.0.md](./FEATURE-ALIGNMENT-1.0.md) | 功能对齐 · 方案 A | 已定 |
| [INTERACTION-1.0.md](./INTERACTION-1.0.md) | 交互终稿 | 已定 |
| [TECH-NOTES-1.0.md](./TECH-NOTES-1.0.md) | 技术 · Lyra 映射 · P0 分期 | 已定 |
| [LYRA-UPGRADE.md](./LYRA-UPGRADE.md) | 子项目 · 丝滑升级 Lyra | 已定 |
| [GIT_WORKFLOW.md](./GIT_WORKFLOW.md) | 分支 · PR · bootstrap | 已定 |
| [PROJECT_STRUCTURE.md](./PROJECT_STRUCTURE.md) | 目录结构 | 已定 |
| [PRODUCT_BOUNDARIES.md](./PRODUCT_BOUNDARIES.md) | 可承诺 / 不可承诺 | 已定 |
| [DECISIONS.md](./DECISIONS.md) | 决议表 | 已定 |
| [ROADMAP.md](./ROADMAP.md) | 里程碑勾选 | 进行中 |
